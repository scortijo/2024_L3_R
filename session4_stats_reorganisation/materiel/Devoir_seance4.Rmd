...
Notez que chacun des exercices suivants est indépendant des autres

<br>


- Exercice 1 :  Selectionnez toutes les colonnes de l'objet `nitrate_data` sauf la colonne `Nlevel`.

<br>

- Exercice 2 : Gardez uniquement les lignes de l'objet `nitrate_data` qui sont l'accession `Col-0`.


- Exercice 3 : En utilisant `%>%` afin de ne pas créer d'objet intermédiaire, effectuez la suite d'opérations suivantes:
