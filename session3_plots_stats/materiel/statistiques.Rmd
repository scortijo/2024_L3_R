...
- changer votre répertoire de travail pour être dans le dossier `session3_plots`:


``` {r eval=FALSE}
setwd("~/Desktop/2021_L3_R/session3_stats")
```
...
#### - Déposez avant le 23/10/2024 à minuit sur Moodle le script R de la première moitié du contrôle continu résultant des instructions à la fin des séances 1 et 3.
